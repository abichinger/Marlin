 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.20 }
...
#define Z_PROBE_FEEDRATE_SLOW Z_PROBE_SPEED_FAST
...
#define DELAY_BEFORE_PROBING 800  // (ms) To prevent vibrations from triggering piezo sensors
